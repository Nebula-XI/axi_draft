...
try {
    ...
    auto i2c_mux_info_list = i2c_info_parser.get_info<info_i2c_parser::mux_parser>();
    auto create_i2c_dev = [&](info_i2c_dev&& i2c_dev_info) {
        ...
        auto i2c_axi_info_opt = i2c_info_parser.get_by_uid<info_i2c_parser::axi_parser>(
        ...
        if (i2c_mux_is_present) {
            auto i2c_mux = dev_i2c_mux::create(i2c_axi, i2c_mux_segment, i2c_mux_info.address(),
    ...
    auto i2c_dev_info_list = i2c_info_parser.get_info<info_i2c_parser::dev_parser>();
